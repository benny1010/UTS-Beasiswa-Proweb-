...
<div class="row mt-5 mb-5">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="float-right">
            <a class="btn btn-secondary" href="{{ route('mahas.index') }}"> Kembali</a>
        </div>
    </div>
</div>
...
<form action="{{ route('mahas.store') }}" method="POST">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="beasiswa" placeholder="Content"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
